...
CREATE TABLE `__new_users_table` (
	...
	`key` text DEFAULT 'ab89ec17-a004-4fa2-a2c8-8d86c15a7a24' NOT NULL,
...
ALTER TABLE `screenshots_table` ADD `height` integer;--> statement-breakpoint
ALTER TABLE `screenshots_table` ADD `width` integer;