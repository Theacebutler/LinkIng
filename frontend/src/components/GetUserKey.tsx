  ...
  return (
    <>
      <div className="card p-4">
        ...
        <button
          onClick={handleClick}
          className="w-full flex items-center justify-center px-4 py-2 rounded-lg text-sm font-semibold text-text-soft transition-colors hover:bg-primary hover:text-text bg-surface/50 border border-border/60"
        >
          Get your API key
        </button>
      </div>
